...
public class TouristRecyclerAdapter extends RecyclerView.Adapter<TouristRecyclerAdapter.TouristHolder> {
    ...
    public TouristHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        //TextView v = (TextView) inflater.inflatefrom(parent.getContext()).inflate(android.R.layout.simple_list_item_1, parent, false);
        //Button v = (Button) LayoutInflater.from(parent.getContext()).inflate(android.R.layout.simple_list_item_1, parent, false);
